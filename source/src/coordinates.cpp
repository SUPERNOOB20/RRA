...
Rect_Coordinates::Rect_Coordinates(std::tuple<int, int, int, int> int_coords)
    : top_left_corner{ std::tuple<int, int> (std::get<0>(int_coords), std::get<1>(int_coords)) }
    , bottom_right_corner{ std::tuple<int, int> (std::get<2>(int_coords), std::get<3>(int_coords)) }
{
}



std::tuple<int, int> Rect_Coordinates::get_top_left_corner(Rect_Coordinates coords){
...
std::tuple<int, int> Rect_Coordinates::get_bottom_right_corner(Rect_Coordinates coords){
