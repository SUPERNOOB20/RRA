...
struct Rect_Coordinates{
    ...
    public:
        Rect_Coordinates(std::array<int, 2> top_left_corner, std::array<int, 2> bottom_right_corner);
        Rect_Coordinates(std::array<std::array<int, 2>, 2> top_left_and_bottom_right_corners_inside_tuple);
        Rect_Coordinates(std::array<int, 4> int_coords);

        std::array<int, 2> get_top_left_corner(Rect_Coordinates coords);
        int get_top_left_corner_x(Rect_Coordinates coords);
        int get_top_left_corner_y(Rect_Coordinates coords);
        std::array<int, 2> get_bottom_right_corner(Rect_Coordinates coords);
